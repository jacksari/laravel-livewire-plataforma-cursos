        ...
        <div class="container">
            ...
            <div class="w-full max-w-7xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                ...
                <div class="p-3 sm:px-5 sm:py-4 border-b border-gray-100 flex items-center justify-between">
                    <h2 class="font-semibold text-gray-800 hidden sm:block">Editar profesor</h2>
                    ...
                    <div class="overflow-x-auto">
                        ...
                        <div class="w-full ">
                            ...
                            <p class="p-1 px-2 appearance-none border-0 focus:border-0 focus:ring-0 focus:border-transparent outline-none w-full text-gray-800">
                                Usuario: {{ $teacher->user->name }} - Correo: {{ $teacher->user->email }}
                            </p>
                            </div>
                        </div>

                        {!! Form::model($teacher, ['route' => ['admin.teachers.update', $teacher], 'method' => 'put', 'files' => true]) !!}
