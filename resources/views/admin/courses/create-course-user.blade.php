            ...
            <div class="w-full max-w-7xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                ...
                <div class="p-3">
                    <div class="overflow-x-auto">
                        ...
                        <div class="w-full ">
                            ...
                            <div class="my-1 bg-white p-1 flex border border-gray-200 rounded">
                                <p class="p-1 px-2 appearance-none border-0 focus:border-0 focus:ring-0 focus:border-transparent outline-none w-full text-gray-800">
                                    Profesor: {{ $teacher->user->name }} - Correo: {{ $teacher->user->email }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="w-full py-1 hidden">
                            {!! Form::label('teacher_id', 'Título: ', ['class' => 'label-input']) !!}
                            <div class="my-1 bg-white p-1 flex border border-gray-200 rounded">
                                {!! Form::text('teacher_id', $teacher->id, ['class' => 'input-form']) !!}
                            </div>
                        </div>
