                    ...
                    <form method="POST" action="{{ route('login') }}" class="mt-8 space-y-6">
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class=" w-full text-base px-4 py-2 rounded-2xl border-b border-gray-300 focus:border-primary-500 focus:border-4 focus:outline-none focus:ring-0 focus:ring-2 focus:ring-offset-0 focus:ring-primary-300"
                        ...
                        <div class="mt-8 content-center">
                            ...
                            <input
                                ...
                                class="w-full content-center text-base px-4 py-2 border-b rounded-2xl  border-gray-300 focus:border-primary-500 focus:border-4 focus:outline-none focus:ring-0 focus:ring-2 focus:ring-offset-0 focus:ring-primary-300"
                        ...
                        <div>
                            <button type="submit"
                                    class="w-full flex justify-center bg-gradient-to-r from-primary-500 to-primary-300  hover:bg-gradient-to-l hover:from-primary-300 hover:to-primary-500 text-white p-4  rounded-full tracking-wide font-semibold  shadow-lg cursor-pointer transition duration-500 ease-in-out">
                                Sign in
                            </button>
                        </div>
